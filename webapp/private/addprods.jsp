...
<p class="formbus1"><font face="arial,helvetica,san-serif"><b> <a href="publication.jsp?bib=<%=parametrosFormulario.getBibcode().replaceAll("&", "%26")%>&stateant=<%=stateant%>">Volver a la publicación
</a> </b></font></p>
