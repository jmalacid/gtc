...
<br>
	...
	<table class="appstyle" cellspacing="3" cellpadding="20">
	<tr>
	<td class="rescab" align="right" colspan="3" > Cambiar información de la colección: </td>		
	</tr>
		<tr>
	...
	<table class="appstyle" cellspacing="3" cellpadding="20" >
	<tr>
	<td class="rescab" align="right" colspan="2"> Cambios en la publicación: </td>		
	</tr>
	<tr>
	<td class="rescab" align="right" > Añadir nuevo comentario: </td>	
	...
	<tr>
	<td colspan="2" class="resfield" align="center" > <a href="addprods1.jsp?bib=<%=bibcode.replaceAll("&", "%26")%>&stateant=<%=stateant%>">Añadir múltiples productos</a> </td>
	</tr>
	</table>

	<br>
<input type="submit" name="submit" value="Añadir cambios" />&nbsp; &nbsp;<input
...
<input type="radio" name="type" value="1"> Subir datos<br><input type="radio" name="type" value="3"> Último intento
<br><input type="radio" name="type" value="4"> Último intento (Español)<br><input type="radio" name="type" value="5"> Texto libre<br>
