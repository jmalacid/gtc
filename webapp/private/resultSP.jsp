...
<br>
<p>Publicaciones revisadas que ya están en el archivo <%=bus.getBib_no().split(";").length %></p>
<br>
<p class="link"><a href="verSP.jsp?bus=gtc">Ir a la gestión de publicaciones</a></p>
