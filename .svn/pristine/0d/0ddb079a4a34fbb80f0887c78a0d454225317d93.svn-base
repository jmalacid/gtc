...
public class Configuration extends JDialog {
	...
	public Configuration(JFrame ventanaPadre, Config config){

		// Ventana padre y modal
	...
	private void initialize() {
		...
		//contentPane.setIconImage(Toolkit.getDefaultToolkit().getImage(ConfigurationOld.class.getResource("/svo/gtc/ingestion/gui/iconoSVO.png")));
		setTitle("Configuración");
		setBounds(100, 100, 504, 236);
		...
		contentPane.add(lblPathBase, gbc_lblPathBase);
		...
		contentPane.add(txtPathBase, gbc_txtPathBase);
		...
		btnOpenPathBase.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int rVal= c.showOpenDialog(Configuration.this);
		...
		contentPane.add(btnOpenPathBase, gbc_btnOpenPathBase);
		...
		contentPane.add(lblPathData, gbc_lblPathData);
		...
		contentPane.add(txtPathData, gbc_txtPathData);
		...
		contentPane.add(lblPathLogs, gbc_lblPathLogs);
		...
		contentPane.add(txtPathLog, gbc_txtPathLog);
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(Configuration.this, e1.getMessage(), "Error guardando datos", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
