...
public class ModoDb {
	...
	public ModoDb(ResultSet resset) throws SQLException{
		this.insId 	= resset.getString("ins_id");
		this.modId 	= resset.getString("mod_id");
		this.modShortname 	= resset.getString("mod_shortname");
		this.modName 	= resset.getString("mod_name");
		this.modDesc 	= resset.getString("mod_desc");
	}
